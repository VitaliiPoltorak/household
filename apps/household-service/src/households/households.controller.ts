...
export class HouseholdsController {
  ...
  findAll(@Headers('x-user-id') userId: string) {
    this.requireUser(userId);
    return this.svc.findUserHouseholds(userId);
  }
  ...
  getMembers(@Headers('x-user-id') userId: string, @Param('id') id: string) {
    this.requireUser(userId);
    return this.svc.getMembers(id, userId);
  }
  ...
  updateMemberRole(
    ...
    this.requireUser(userId);
    return this.svc.updateMemberRole(id, userId, memberId, dto);
  }
  ...
  removeMember(
    ...
    this.requireUser(userId);
    return this.svc.removeMember(id, userId, memberId);
  }
  ...
  createInvite(
    ...
    this.requireUser(userId);
    return this.svc.createInvite(id, userId, dto);
  }
  ...
  getInvites(@Headers('x-user-id') userId: string, @Param('id') id: string) {
    this.requireUser(userId);
    return this.svc.getInvites(id, userId);
  }
  ...
  deleteInvite(
    ...
    this.requireUser(userId);
    return this.svc.deleteInvite(id, userId, inviteId);
  }
