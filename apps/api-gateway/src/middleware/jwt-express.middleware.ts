...
const PUBLIC_PATHS = [
  ...
  // Monobank calls this directly (#292) — no JWT, only the path secret
  // integration-service itself verifies. Covers both the GET URL-check and
  // the POST statement push.
  '/api/v1/integrations/monobank/webhook',
];
